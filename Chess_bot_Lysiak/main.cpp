...
// This "while" ending work when one of king is out of game:
    while((c.count_the_points()<300) && (c.count_the_points()>-300)){  // checking the check-mate
        ...
        for(i=1; i < list_of_move->size_of_list();i++){ // Funkcja wykonuje mo¿liwe ruchy i od ka¿dego ruchu wywo³uje funkcjê oceny. Ten ruch po którym ocena zwróci³a najwiêksz¹ wartoœæ jest najlepszy i zostanie on potem wykonany
